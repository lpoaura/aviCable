  ...
  <v-card elevation="0" class="fill-height">
    <v-layout full-height>
      <v-form ref="form" v-model="formValid" class="fill-height text-center">
        ...
        <v-main scrollable>
          <v-card-text>
            <v-container v-if="!(diagnosis || supportId)">
              <v-row>
...
watch(diagnosis, (_newval, _oldval)=> {
  console.log('WATCH DIAG', _newval, _oldval)
  if (diagnosis) {  initData()}
})
